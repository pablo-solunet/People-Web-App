...
export function TrainingView({ hasActionPermission }: TrainingViewProps) {
  ...
  const filterAndSearchData = () => {
    ...
    if (filterField && filterValue) {
      result = result.filter(record => 
        record[filterField as keyof TrainingData]?.toString().toLowerCase() === filterValue.toLowerCase()
      );
    }
                              ...
                              <TableCell>
                                <div className="flex space-x-2">
                                  <Button 
                                    ...
                                    disabled={record.estado === 'Aprobado' || !hasActionPermission('training-approve')}
                                  >
                                    Aprobar
                                  </Button>
                                  <Button 
                                    ...
                                    disabled={record.estado === 'Rechazado' || !hasActionPermission('training-reject')}
                                  >
                                    Rechazar
                                  </Button>
                                </div>
